...
#define STRING_CONFIG_H_AUTHOR "(chr, default config)" // Who made the changes.
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 46.52
  #define DEFAULT_bedKi 8.31
  #define DEFAULT_bedKd 173.66
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 414.1, 440 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -35, -12, -2.18 }
